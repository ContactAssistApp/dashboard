...
export class Map extends React.Component {
    constructor(props) {
        ...
        this.state = {mapInfo: this.props.mapInfo, cardInfo: []};       
    }
    ...
    componentDidUpdate(){
      //this.setState({cardInfo:() => this.props.cardInfo});
    ...
    loadMapScenario() {
        ...
        console.log('cards:',this.state.cardInfo); //? []
        ...
        const cards = this.state.cardInfo;
